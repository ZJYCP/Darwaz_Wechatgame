cc.Class({
        ...
        if (this.CC_WECHATGAME) {
            window.wx.onMessage(data => {
                ...
                if (data.messageType == 0) {//移除排行榜
                    ...
                    this.fetchFriendData(this.memuKey);
                } else if (data.messageType == 2) { //上传分数
                    this.submitScore(this.memuKey, data.score)
    ...
    submitScore(memuKey, score) { //提交得分
        if (this.CC_WECHATGAME) {
            window.wx.getUserCloudStorage({
                ...
                success: function (getres) {
                    ...
                    window.wx.setUserCloudStorage({
                        KVDataList: [{ key: '' + memuKey, value: '' + score }],
